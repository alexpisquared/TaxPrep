...
public class MainAppDispatcherNavSvc : LayoutNavSvc<MainAppDispatcherVM> { public MainAppDispatcherNavSvc(NavigationStore ns, Func<MainAppDispatcherVM> vm, Func<NavBarVM> nb) : base(ns, vm, nb) { } }
