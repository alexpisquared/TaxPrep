namespace MinFin.Report.WinForm
{
	partial class Form1
	{
		 ...
		 void InitializeComponent()
		{
			...
			this.Vw_TaxLiqReport_UnifiedTableAdapter = new MinFin.Report.WinForm.findemoDataSetTableAdapters.Vw_TaxLiqReport_UnifiedTableAdapter();
			...
			this.reportViewer1.LocalReport.ReportEmbeddedResource = "MinFin.Report.WinForm.Report3_Unified.rdlc";
