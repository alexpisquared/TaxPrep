namespace MinFin.Report.WinForm//.Mei
{
  partial class Form1_Mei
  {
    ...
    void InitializeComponent()
    {
      ...
      this.findemoDataSet = new MinFin.Report.WinForm.findemoDataSet();
      this.Vw_TaxLiqReport_MeiTableAdapter = new MinFin.Report.WinForm.findemoDataSetTableAdapters.Vw_TaxLiqReport_MeiTableAdapter();
      ...
      this.reportViewer1.LocalReport.ReportEmbeddedResource = "MinFin.Report.WinForm.Report3_Mei.rdlc";
