namespace MinFin.Report.WinForm//.Alx
{
  partial class Form1_Alx
  {
    ...
    void InitializeComponent()
    {
      ...
      this.Vw_TaxLiqReport_AlxTableAdapter = new MinFin.Report.WinForm.findemoDataSetTableAdapters.Vw_TaxLiqReport_AlxTableAdapter();
      ...
      this.reportViewer1.LocalReport.ReportEmbeddedResource = "MinFin.Report.WinForm.Report3_Alx.rdlc";
