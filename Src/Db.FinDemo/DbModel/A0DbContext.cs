namespace Db.FinDemo.DbModel
{
  ...
  public partial class A0DbContext : DbContext
  {
    ...
    public virtual DbSet<Vw_TaxLiqReport_Alx> Vw_TaxLiqReport_Alx { get; set; }
    public virtual DbSet<Vw_TaxLiqReport_Mei> Vw_TaxLiqReport_Mei { get; set; }
    ...
    protected override void OnModelCreating(DbModelBuilder modelBuilder)
    {
      ...
      modelBuilder.Entity<Vw_TaxLiqReport_Alx>()
          .Property(e => e.Group)
          .IsUnicode(false);
      ...
      modelBuilder.Entity<Vw_TaxLiqReport_Mei>()
          .Property(e => e.Group)
          .IsUnicode(false);
