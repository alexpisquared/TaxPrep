...
2. Dnld txns and run query C:\c\Live\MinFin\MF.TxCategoryAssigner\sql\HST.2023.sql
...
select @q0 = CONVERT(DATETIME, '2023-01-01 00:00:00', 102), @q1 = CONVERT(DATETIME, '2023-04-01 00:00:00', 102), @q2 = CONVERT(DATETIME, '2023-07-01 00:00:00', 102), @q3 = CONVERT(DATETIME, '2023-10-01 00:00:00', 102), @q4 = CONVERT(DATETIME, '2024-01-01 00:00:00', 102)
